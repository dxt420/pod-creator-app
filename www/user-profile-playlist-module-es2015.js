...
let PlaylistService = class PlaylistService {
    ...
    getPlaylistsDataSource() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.nativeHttp.get('http://pod.pythonanywhere.com/api/playlists/', {}, {})).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => new _profile_playlist_model__WEBPACK_IMPORTED_MODULE_7__["PlaylistModel"]()));
        // });
        // return defer(
        //   this.nativeHttp.get('http://pod.pythonanywhere.com/api/playlists/',{},{})
        // );
    ...
    getPlaylistsStore(dataSource) {
        ...
        if (!this.playlistDataStore) {
            ...
            const shellModel = new _profile_playlist_model__WEBPACK_IMPORTED_MODULE_7__["PlaylistModel"]();
...
class PlaylistModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_0__["ShellModel"] {
    constructor() {
        super();
        this.songs = [
            {
